...
public class OrderDB extends SQLiteOpenHelper {
    ...
    interface Tables{
        ...
        String DEPT_MANAGER = "dept_manager";
    }
    ...
    interface References{
        ...
        String ID_DEPT_MANAGER = String.format("REFERENCES %s(%s)"+ "ON DELETE CASCADE", Tables.DEPT_MANAGER, OrderContract.DeptManagers.ID);
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(String.format("CREATE TABLE %s (%s INTEGER PRIMARY KEY" +
                ...
                Tables.DEPT_MANAGER, BaseColumns._ID,
                OrderContract.DeptManagers.ID,
                OrderContract.DeptManagers.NAMEDEPT,
                OrderContract.DeptManagers.FROMDATE,
                OrderContract.DeptManagers.TODATE));
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS "+Tables.DEPT_MANAGER);
